import{ab as a,C as s,D as n,ad as e}from"./framework-e618a78f.js";const i={},c=e(`<h2 id="查看cpu频率" tabindex="-1"><a class="header-anchor" href="#查看cpu频率" aria-hidden="true">#</a> 查看CPU频率</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">watch</span> <span class="token function">grep</span> <span class="token punctuation">\\</span>&#39;cpu MHz<span class="token punctuation">\\</span>&#39; /proc/cpuinfo
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),t=[c];function d(r,l){return s(),n("div",null,t)}const p=a(i,[["render",d],["__file","通用命令.html.vue"]]);export{p as default};
