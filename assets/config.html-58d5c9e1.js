import{ab as a,C as e,D as n,ad as s}from"./framework-e618a78f.js";const i={},d=s(`<h2 id="运行命令" tabindex="-1"><a class="header-anchor" href="#运行命令" aria-hidden="true">#</a> 运行命令</h2><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker run [OPTIONS] IMAGE [COMMAND] [ARG...]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="options说明" tabindex="-1"><a class="header-anchor" href="#options说明" aria-hidden="true">#</a> OPTIONS说明</h5><ul><li><code>-d</code> : 后台运行</li><li><code>-it</code> : 交互模式运行</li><li><code>-p 3000:3000</code> : 指定端口映射，<code>主机(宿主)端口:容器端口</code></li><li><code>--name bestrui</code> : 容器名字</li><li><code>--dns 111.11.1.1</code> : 指定DNS服务器</li><li><code>--net=&quot;bridge&quot;</code> : 指定容器的网络类型</li><li><code>-v /docker:/app</code> : 绑定目录，<code>主机(宿主)目录:容器目录</code></li><li><code>-e TZ=Asia/Shanghai</code> : 环境变量：时区</li><li><code>--restart=always</code> : 重启策略</li></ul><div class="language-tip line-numbers-mode" data-ext="tip"><pre class="language-tip"><code>- no 默认值，表示容器退出时，docker不自动重启容器
- always 容器退出时总是重启
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-tip line-numbers-mode" data-ext="tip"><pre class="language-tip"><code>命令最后的 ==**.**== 不能省略
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="创建网络" tabindex="-1"><a class="header-anchor" href="#创建网络" aria-hidden="true">#</a> 创建网络</h2><ul><li><h4 id="macvlan网络" tabindex="-1"><a class="header-anchor" href="#macvlan网络" aria-hidden="true">#</a> macvlan网络</h4></li></ul><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker network create -d \\
       macvlan -o \\
        parent=eth0 \\
        RUI \\
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15),l=[d];function c(r,o){return e(),n("div",null,l)}const v=a(i,[["render",c],["__file","config.html.vue"]]);export{v as default};
