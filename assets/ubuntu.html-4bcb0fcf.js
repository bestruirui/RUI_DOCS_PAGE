...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="绑定核显到vfio模块" tabindex="-1"><a class="header-anchor" href="#绑定核显到vfio模块" aria-hidden="true">#</a> 绑定核显到vfio模块</h4><p>查看核显以及声卡的ID： <img src="`+s+'" alt="" loading="lazy"><img src="'+d+`" alt="" loading="lazy"> 根据ID修改下面的命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">&quot;options vfio-pci ids=8086:3185,8086:3198&quot;</span> <span class="token operator">&gt;</span> /etc/modprobe.d/vfio.conf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23),o=[r];function t(v,u){return i(),n("div",null,o)}const b=e(l,[["render",t],["__file","ubuntu.html.vue"]]);export{b as default};
